...
st.title("📊 Dashboard Analisis Reliabilitas & Konsistensi Tes")
...
# ==============================
# 1️⃣ RATA-RATA & VARIABILITAS SOAL
# ==============================
st.header("1️⃣ Analisis Statistik Soal")
...
with col2:
    st.subheader("📊 Standar Deviasi Soal")
...
# ==============================
# 3️⃣ CRONBACH'S ALPHA
# ==============================
st.header("3️⃣ Analisis Reliabilitas (Cronbach's Alpha)")
...
# ==============================
# 4️⃣ IDENTIFIKASI SOAL TIDAK KONSISTEN
# ==============================
st.header("4️⃣ Identifikasi Soal Tidak Konsisten")
...
# ==============================
# 5️⃣ INSIGHT OTOMATIS
# ==============================
st.header("5️⃣ Insight Otomatis")
